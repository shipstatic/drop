...
import { getMimeType } from '../../src/utils/mimeType';
...
describe('getMimeType', () => {
  ...
  describe('real-world file examples', () => {
    ...
    it('should handle asset files from static sites', () => {
      expect(getMimeType('assets/stars-S.svg')).toBe('image/svg+xml');
      expect(getMimeType('assets/glove.png')).toBe('image/png');
      expect(getMimeType('styles.css')).toBe('text/css');
      expect(getMimeType('README.md')).toBe('text/markdown');
    });
  });
