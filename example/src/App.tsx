  ...
  return (
    ...
    >
      ...
      {drop.phase === 'processing' && drop.status && (
        ...
        >
          <div style={{ color: '#1e40af', fontWeight: 500 }}>{drop.status.title}</div>
      ...
      {drop.phase === 'ready' && drop.sourceName && (
        ...
        >
          ...
          <div style={{ color: '#16a34a', fontSize: '0.9rem' }}>
            {drop.validFiles.length} {drop.validFiles.length === 1 ? 'file' : 'files'} ready to
            deploy
          </div>
        </div>
      )}
      ...
      {drop.phase === 'error' && drop.status && (
        ...
        >
          ...
          <div style={{ color: '#dc2626', fontSize: '0.9rem' }}>{drop.status.details}</div>
        </div>
      )}
